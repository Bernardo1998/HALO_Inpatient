...
new_df = pd.read_csv(acoustic_file)
...
os.makedirs("./dvlog/acoustic/",exist_ok=True)
pickle.dump(code_to_index, open("./dvlog/acoustic/codeToIndex.pkl", "wb"))
pickle.dump(index_to_code, open("./dvlog/acoustic/indexToCode.pkl", "wb"))
pickle.dump(train_dataset, open("./dvlog/acoustic/trainDataset.pkl", "wb"))
pickle.dump(val_dataset, open("./dvlog/acoustic/valDataset.pkl", "wb"))
pickle.dump(test_dataset, open("./dvlog/acoustic/testDataset.pkl", "wb"))
